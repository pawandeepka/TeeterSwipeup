...
public class CardContainerViewLeft extends FrameLayout {
    ...
    public CardContainerViewLeft(Context context) {
        this(context, null);
    }

    public CardContainerViewLeft(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CardContainerViewLeft(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOverlayLeft(int left,int bottom, int top) {
