...
public class CardContainerViewRight extends FrameLayout {
    ...
    public CardContainerViewRight(Context context) {
        this(context, null);
    }

    public CardContainerViewRight(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CardContainerViewRight(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOverlayRight(int right, int bottom, int top) {
